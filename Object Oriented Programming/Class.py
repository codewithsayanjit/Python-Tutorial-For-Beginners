...
class Employee: 
    language = "Py" # This is a class attribute. An attribute that belongs to the class rather than a particular object.
    salary = 1200000


harry = Employee()
harry.name = "Sayanjit" # This is an instance attribute.An attribute that belongs to the Instance (object).
